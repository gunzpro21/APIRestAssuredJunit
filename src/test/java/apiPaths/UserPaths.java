...
/**
 * <h1>Add a ping!</h1> The APITest holds all paths of an API module that is
 * store all URL extension
 * 
 * @author Joe Phan
 * @since 2022 Oct 14th
 */
...
public class UserPaths {
	...
	public static final String GET_POSITON_DETAIL = "/api/positions/3079";

	// POST
	public static final String CREATE_A_USER = "/api/users";

	
	public static final String UPDATE_POSITION_DETAIL = "/api/positions/3079/static-details";
}
